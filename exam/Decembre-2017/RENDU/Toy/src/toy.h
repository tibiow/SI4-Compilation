 ...
 * toy.h        -- Toy Language
 *
 * Copyright © 2014-2017 Erick Gallesio - I3S-CNRS/Polytech Nice-Sophia<eg@unice.fr>
 *
 *
 ...
 *Last file update: 17-Dec-2017 20:09 (eg)
 */
...
extern int  debug_mode;                 /* debug option was present */
