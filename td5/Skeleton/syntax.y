...
// Last file update:  4-Nov-2015 20:05 (eg)
...
stmt:
    ...
    | expr ';'                         { $$ = $1; }
        ...
        | '{' stmt_list '}'                { $$ = $2; }
        | KWHILE'('expr')'stmt         { $$ = make_operator(KWHILE, 2, $3, $5); }
        | KIF'('expr')'stmt         { $$ = make_operator(KIF, 2, $3, $5); }
        | KIF'('expr')'stmt KELSE stmt        { $$ = make_operator(KIF, 3, $3, $5, $7); }
        | KREAD expr ';'                   { $$ = make_operator(KREAD,1,$2);}
        ;
