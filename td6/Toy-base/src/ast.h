 ...
 * Last file update: 16-Nov-2015 11:58 (eg)
 */
...
enum node_kind {k_constant, k_identifier, k_type, k_var_decl, k_expression, 
                ...
                k_if_statement, k_while_statement,
                k_block_statement, k_expr_statement, k_print_statement,
                k_return_statement, k_break_statement,k_for_statement,k_switch_statement};
...
struct s_constant {
  ...
  union {
    ...
    char *svalue;
    float fvalue;
  } value;              ///< Value of the constant (can be int, bool or string)
};
...
//
// ======================================================================
enum expr_kind {assign, uarith, barith, ulogic, blogic, comp, ternary, parenthesis,pre,post};
