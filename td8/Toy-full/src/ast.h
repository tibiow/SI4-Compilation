 ...
 * Last file update:  6-Dec-2015 19:20 (eg)
 */
...
enum node_kind {k_constant, k_identifier, k_type,
                k_var_decl, k_class, k_instance_new, k_this,
                ...
                k_return_statement, k_break_statement,k_read_statement};
...
#define CONSTANT_NULL_VALUE(p)  (((struct s_constant *) p)->value.nullvalue)
